...
$lang['default.root.category.description'] = '
    ...
    <h2 class="formatter-title">Bienvenue sur le module Pages</h2>
    Une catégorie et une page ont été créées. Voici quelques conseils pour bien débuter sur ce module.
	<br />
	<ul class="formatter-ul">
		<li class="formatter-li"> Pour configurer ou personnaliser l\'accueil de votre module, rendez-vous dans l\'<a class="offload" href="' . ModulesUrlBuilder::configuration('pages')->relative() . '">administration du module</a></li>
		<li class="formatter-li"> Pour créer des catégories, <a class="offload" href="' . CategoriesUrlBuilder::add(Category::ROOT_CATEGORY, 'pages')->relative() . '">cliquez ici</a> </li>
		<li class="formatter-li"> Pour ajouter des pages, <a class="offload" href="' . ItemsUrlBuilder::add(Category::ROOT_CATEGORY, 'pages')->relative() . '">cliquez ici</a></li>
	</ul>
