	...
	<div class="subcat-container">
		...
		<div class="subcat-element" style="width:{CATS_COLUMNS_WIDTH}%;">
			<div class="subcat-content">
				# IF sub_categories_list.C_CATEGORY_THUMBNAIL #<a itemprop="about" href="{sub_categories_list.U_CATEGORY}"><img itemprop="thumbnailUrl" src="{sub_categories_list.CATEGORY_THUMBNAIL}" alt="{sub_categories_list.CATEGORY_NAME}" /></a># ENDIF #
				<br />
