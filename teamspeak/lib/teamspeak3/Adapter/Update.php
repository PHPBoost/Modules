 ...
 *
 * $Id: Update.php 12/3/2010 9:53:21 scp@orilla $
 *
...
class TeamSpeak3_Adapter_Update extends TeamSpeak3_Adapter_Abstract
{
  ...
  public function syn()
  {
    ...
    if(!preg_match_all("/,?(\d+),?/", $this->getTransport()->read(20), $matches) || !isset($matches[1]))
    {
  ...
  public function getRev($channel = "stable")
  {
    switch($channel)
    {
      ...
      default:
        throw new TeamSpeak3_Adapter_Exception("invalid update channel identifier");
    }
  }
}
