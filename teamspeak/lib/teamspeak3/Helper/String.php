 ...
 *
 * $Id: String.php 12/3/2010 9:53:21 scp@orilla $
 *
...
class TeamSpeak3_Helper_String implements ArrayAccess, Iterator, Countable
{
  ...
  public function __call($function, $args)
  {
    ...
    if(count($args))
    {
      ...
      {
        throw new TeamSpeak3_Helper_Exception("cannot call undefined function '" . $function . "' without the " . self::class . " object parameter");
      }
