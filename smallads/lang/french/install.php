...
$lang['default.smallad.content'] = '
	<p>
		Cette première annonce va vous donner quelques conseils simples pour prendre en main ce module.
	</p>
	...
	<ul class="formatter-ul">
		<li class="formatter-li">
			Pour mettre en page vos articles, vous pouvez utiliser le langage bbcode ou l\'éditeur WYSIWYG (cf cet <a class="offload" href="https://www.phpboost.com/wiki/bbcode">article</a>)<br />
		</li>
	</ul>
	<p>
