...
class SmalladsTreeLinks extends DefaultTreeLinks
{
	...
	protected function get_module_additional_actions_tree_links(&$tree)
	{
		...
		$tree->add_link(new ModuleLink($lang['my.items'], SmalladsUrlBuilder::display_member_items($current_user), $this->check_write_authorization() || $this->get_authorizations()->moderation()));
		$tree->add_link(new ModuleLink($lang['archived.items'], SmalladsUrlBuilder::archived_items(), $this->get_authorizations()->moderation()));
