# IF C_SMALLADS #
	# IF C_HORIZONTAL #
		<div id="smallads-mini-module" class="block-container# IF C_HIDDEN_WITH_SMALL_SCREENS # hidden-small-screens# ENDIF #">
				...
				<li>
	        		<a
						...
						<div class="smallads-mini-infos">
							...
							<span class="more">{items.SMALLAD_TYPE} - <i class="fa fa-fw fa-calendar" aria-hidden="true"></i> <time datetime="# IF NOT items.C_DIFFERED #{items.DATE_ISO8601}# ELSE #{items.PUBLICATION_START_DATE_ISO8601}# ENDIF #" itemprop="datePublished"># IF NOT items.C_DIFFERED #{items.DATE_RELATIVE}# ELSE #{items.PUBLICATION_START_DATE_RELATIVE}# ENDIF #</time></span>
						</div>
					</a>
				</li>
	            # END items #
