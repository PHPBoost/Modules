...
class SmalladsItemsManagerController extends ModuleController
{
	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			...
			$delete_link = new LinkHTMLElement(SmalladsUrlBuilder::delete_item($smallad->get_id()), '', array('aria-label' => LangLoader::get_message('delete', 'common'), 'data-confirmation' => 'delete-element'), 'fa fa-delete');
