<?php
/*##################################################
 *		      SmalladsFormFieldSelectSources.class.php
 *                            -------------------
 *   begin                : March 15, 2018 
...
class SmalladsFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('smallads/fields/SmalladsFormFieldSelectSources.tpl');
