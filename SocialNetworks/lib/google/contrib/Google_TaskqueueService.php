...
class Google_TaskQueueAcl extends Google_Model {
  ...
  public $adminEmails;
  public function setConsumerEmails(/* [Google_string] */ $consumerEmails) {
  ...
  public function setProducerEmails(/* [Google_string] */ $producerEmails) {
  ...
  public function setAdminEmails(/* [Google_string] */ $adminEmails) {
...
class Google_Tasks extends Google_Model {
  ...
  public $items;
  public $kind;
  public function setItems(/* [Google_Task] */ $items) {
