<article id="component-sortable" class="sandbox-block">
    <header>
        <h5>{@sandbox.component.sortable}</h5>
    </header>
    <div class="content">
        <ul class="sortable-block">
            <li class="sortable-element">
                ...
                <div class="sortable-title">
                    <span><a>{@sandbox.component.static.sortable}</a></span>
                </div>
            </li>
            <li class="sortable-element dragged" style="position: relative;">
                <div class="sortable-selector" aria-label="{@sandbox.component.sortable.move}"></div>
                <div class="sortable-title">
                    <span><a>{@sandbox.component.moving.sortable}</a></span>
                </div>
            </li>
            <li>
                <div class="dropzone">{@sandbox.component.dropzone}</div>
            </li>
        </ul>
    </div>
    <!-- Source code -->
