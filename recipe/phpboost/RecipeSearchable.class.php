...
class RecipeSearchable extends DefaultSearchable
{
	public function __construct()
	{
		...
		$this->table_name = RecipeSetup::$recipe_table;

		$this->authorized_categories = CategoriesService::get_authorized_categories(Category::ROOT_CATEGORY, RecipeConfig::load()->is_summary_displayed_to_guests(), $module_id);
