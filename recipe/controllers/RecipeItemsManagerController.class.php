...
class RecipeItemsManagerController extends DefaultModuleController
{
	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			...
			$row = array(
				new HTMLTableRowCell(new LinkHTMLElement(RecipeUrlBuilder::display($category->get_id(), $category->get_rewrited_name(), $item->get_id(), $item->get_rewrited_title()), $item->get_title()), 'left'),
