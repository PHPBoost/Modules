...
class WikiTagController extends DefaultModuleController
{
    ...
    private function generate_response(HTTPRequestCustom $request)
    {
        ...
        $graphical_environment->get_seo_meta_data()->set_description(StringVars::replace_vars($this->lang['wiki.seo.description.tag'], ['subject' => $this->get_keyword()->get_name()]), $page);
