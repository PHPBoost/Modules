...
$lang['flux.root.category.description'] = '
    ...
    <ul class="formatter-ul">
    	...
    	<li class="formatter-li"> To create categories, <a class="offload" href="' . Url::to_rel(CategoriessUrlBuilder::add()->relative(Category::ROOT_CATEGORY, 'flux')) . '">clic here</a></li>
