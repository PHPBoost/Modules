...
class DictionaryTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$tree->add_link(new AdminModuleLink($category_lang['category.categories.management'], new Url('/dictionary/admin_dictionary_cats.php')));
		$tree->add_link(new AdminModuleLink($category_lang['category.add'], new Url('/dictionary/admin_dictionary_cats.php?add=1')));
