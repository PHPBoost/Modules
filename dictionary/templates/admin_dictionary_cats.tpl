...
<div id="admin-contents">
	# INCLUDE MSG #
	# START add #
		<form action="admin_dictionary_cats.php?add=1&token={TOKEN}" method="post" enctype="multipart/form-data" onsubmit="return check_form_conf(this);" class="fieldset-content">
			<fieldset>
	...
	# END add #
	# IF LIST_CAT #
		<form action="admin_dictionary_cats.php?token={TOKEN}" method="post" class="fieldset-content">
			<table>
				<thead>
					<tr>
							...
							# START cat #
								<div style="margin-bottom:5px;height:20px;">
									...
									<span class="float-right">
										<a href="admin_dictionary_cats.php?add=1&id={cat.ID_CAT}&token={TOKEN}" class="fa fa-edit"></a>&nbsp;
	...
	# IF DEL_CAT_NOEMPTY #
		<form action="admin_dictionary_cats.php?token={TOKEN}" method="post" class="fieldset-content">
			<fieldset>
				...
				<label>
					<input name="action" value="delete" type="radio"> {L_DEL_CAT_DEF}
				</label>
				<br><br>
				<label>
					<input name="action" value="move" checked="checked" type="radio"> {L_MOVE} :
				</label>
			...
			<fieldset class="fieldset-submit">
				<legend>{L_DEL}</legend>
				<button type="submit" name="submit" value="true">{L_DEL}</button>
