...
<section>
	...
	# IF NOT C_EDIT #
		<div style="text-align:center" class="dictionary_letter">
			...
			<div style="text-align:left;margin-top:-10px;">
				...
				# START cat #
					<span id="{cat.ID}" style="display:none;"><a href="javascript:affCacheCat('{cat.ID}');" style="text-decoration:none;color:#FFFFFF;">{cat.NAME}&nbsp;<img src="./templates/images/plus.png"/> </a></span>
				# END cat #
				<span id="ALL" style=""><a href="javascript:affCacheCat('ALL');" style="text-decoration:none;color:#FFFFFF;">{L_ALL_CAT} &nbsp;<img src="./templates/images/plus.png"/> </a></span>
				...
				<div>
					...
					<div style="float:right">
						# IF dictionary.EDIT_CODE #
							<a href="{PATH_TO_ROOT}/dictionary/dictionary.php?edit={dictionary.ID_EDIT}&token={TOKEN}" class="fa fa-edit"></a>
						# ENDIF #
	...
	# IF C_EDIT #
		# IF C_ARTICLES_PREVIEW #
			...
			<div class="spacer">&nbsp;</div>
		# ENDIF #
		<form action="dictionary.php?token={TOKEN}" name="form" method="post" onsubmit="return check_form_or();"  class="fieldset-content">
			<fieldset>
