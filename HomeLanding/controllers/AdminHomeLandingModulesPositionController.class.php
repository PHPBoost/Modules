...
class AdminHomeLandingModulesPositionController extends AdminModuleController
{
	...
	private function init()
	{
		...
		$this->view->add_lang(array_merge($this->lang, LangLoader::get('common', 'HomeLanding'), LangLoader::get('common-lang'), LangLoader::get('form-lang')));
	...
	private function update_modules(HTTPRequestCustom $request)
	{
		if ($request->get_value('submit', false))
		{
			...
			$this->view->put('MESSAGE_HELPER', MessageHelper::display(LangLoader::get_message('message.success.position.update', 'status-messages-common'), MessageHelper::SUCCESS, 5));
		}
	}
