...
$lang['spots.labels.facebook']       = 'Facebook account url <i class="fab fa-fw fa-facebook" aria-hidden="true"></i>';
$lang['spots.placeholder.facebook']  = 'https://www.facebook.com/...';
$lang['spots.labels.twitter']        = 'X (ex-Twitter) account url <i class="fab fa-fw fa-x-twitter" aria-hidden="true"></i>';
$lang['spots.placeholder.twitter']   = 'https://www.x.com/...';
$lang['spots.labels.instagram']      = 'Instagram  account url<i class="fab fa-fw fa-instagram" aria-hidden="true"></i>';
$lang['spots.placeholder.instagram'] = 'https://www.instagram.com/...';
$lang['spots.labels.youtube']        = 'Youtube account url <i class="fab fa-fw fa-youtube" aria-hidden="true"></i>';
...
$lang['spots.no.default.gmap']    = 'The module GoogleMaps is activated. You must configure it (key + default location).';
