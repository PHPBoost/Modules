...
$lang['spots.duplicate']  = 'Dupliquer une localisation';
...
$lang['spots.labels.twitter']        = 'Adresse du compte X (ex-Twitter) <i class="fab fa-fw fa-x-twitter" aria-hidden="true"></i>';
