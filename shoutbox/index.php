...
$url_controller_mappers = [
    ...
    new UrlControllerMapper('ShoutboxFormController', '`^/([0-9]+)/edit/?([0-9]+)?/?$`', ['id', 'page']),
    new UrlControllerMapper('ShoutboxDeleteController', '`^/([0-9]+)/delete/?$`', ['id']),
    new UrlControllerMapper('ShoutboxHomeController', '`^(?:/manage)?(?:/([0-9]+))?/?$`', ['page']),
];
